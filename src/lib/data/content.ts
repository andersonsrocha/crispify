...
<h1>Introduction</h1>
    ...
    <p>
      ...
      (<code>Sketch</code> and <code>Axure</code>), to help people create their product
    ...
    <p>
      ...
      Ant Design。基于<mark>『确定』和『自然』</mark>
    ...
    <p>
      我们提供完善的设计原则、最佳实践和设计资源文件（<code>Sketch</code> 和
      <code>Axure</code>），来帮助业务快速设计出高质量的产品原型。
    </p>

      <ul>
        <li>
          <a href="/docs/spec/proximity-cn">设计原则</a>
        </li>
        <li>
          <a href="/docs/spec/overview-cn">设计模式</a>
        </li>
        <li>
          <a href="/docs/resources-cn">设计资源</a>
        </li>
      </ul>
